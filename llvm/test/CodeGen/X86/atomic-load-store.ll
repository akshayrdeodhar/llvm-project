...
; RUN: llc < %s -mtriple=x86_64-- -verify-machineinstrs -mcpu=x86-64    | FileCheck %s --check-prefixes=CHECK,CHECK-O3,CHECK-SSE-O3,CHECK-NOCX16-O3
; RUN: llc < %s -mtriple=x86_64-- -verify-machineinstrs -mcpu=x86-64-v2 | FileCheck %s --check-prefixes=CHECK,CHECK-O3,CHECK-SSE-O3,CHECK-CX16-O3
...
; RUN: llc < %s -mtriple=x86_64-- -verify-machineinstrs -O0 -mcpu=x86-64    | FileCheck %s --check-prefixes=CHECK,CHECK-O0,CHECK-SSE-O0,CHECK-NOCX16-O0
; RUN: llc < %s -mtriple=x86_64-- -verify-machineinstrs -O0 -mcpu=x86-64-v2 | FileCheck %s --check-prefixes=CHECK,CHECK-O0,CHECK-SSE-O0,CHECK-CX16-O0
...
define <2 x double> @atomic_vec2_double(ptr %x) {
; CHECK-NOCX16-O3-LABEL: atomic_vec2_double:
; CHECK-NOCX16-O3:       # %bb.0:
; CHECK-NOCX16-O3-NEXT:    pushq %rax
; CHECK-NOCX16-O3-NEXT:    .cfi_def_cfa_offset 16
; CHECK-NOCX16-O3-NEXT:    movl $2, %esi
; CHECK-NOCX16-O3-NEXT:    callq __atomic_load_16@PLT
; CHECK-NOCX16-O3-NEXT:    movq %rdx, %xmm1
; CHECK-NOCX16-O3-NEXT:    movq %rax, %xmm0
; CHECK-NOCX16-O3-NEXT:    punpcklqdq {{.*#+}} xmm0 = xmm0[0],xmm1[0]
; CHECK-NOCX16-O3-NEXT:    popq %rax
; CHECK-NOCX16-O3-NEXT:    .cfi_def_cfa_offset 8
; CHECK-NOCX16-O3-NEXT:    retq
;
; CHECK-CX16-O3-LABEL: atomic_vec2_double:
; CHECK-CX16-O3:       # %bb.0:
; CHECK-CX16-O3-NEXT:    pushq %rbx
; CHECK-CX16-O3-NEXT:    .cfi_def_cfa_offset 16
; CHECK-CX16-O3-NEXT:    .cfi_offset %rbx, -16
; CHECK-CX16-O3-NEXT:    xorl %eax, %eax
; CHECK-CX16-O3-NEXT:    xorl %edx, %edx
; CHECK-CX16-O3-NEXT:    xorl %ecx, %ecx
; CHECK-CX16-O3-NEXT:    xorl %ebx, %ebx
; CHECK-CX16-O3-NEXT:    lock cmpxchg16b (%rdi)
; CHECK-CX16-O3-NEXT:    movq %rdx, %xmm1
; CHECK-CX16-O3-NEXT:    movq %rax, %xmm0
; CHECK-CX16-O3-NEXT:    punpcklqdq {{.*#+}} xmm0 = xmm0[0],xmm1[0]
; CHECK-CX16-O3-NEXT:    popq %rbx
; CHECK-CX16-O3-NEXT:    .cfi_def_cfa_offset 8
; CHECK-CX16-O3-NEXT:    retq
;
; CHECK-AVX-O3-LABEL: atomic_vec2_double:
; CHECK-AVX-O3:       # %bb.0:
; CHECK-AVX-O3-NEXT:    vmovaps (%rdi), %xmm0
; CHECK-AVX-O3-NEXT:    retq
;
; CHECK-NOCX16-O0-LABEL: atomic_vec2_double:
; CHECK-NOCX16-O0:       # %bb.0:
; CHECK-NOCX16-O0-NEXT:    pushq %rax
; CHECK-NOCX16-O0-NEXT:    .cfi_def_cfa_offset 16
; CHECK-NOCX16-O0-NEXT:    movl $2, %esi
; CHECK-NOCX16-O0-NEXT:    callq __atomic_load_16@PLT
; CHECK-NOCX16-O0-NEXT:    movq %rdx, %xmm1
; CHECK-NOCX16-O0-NEXT:    movq %rax, %xmm0
; CHECK-NOCX16-O0-NEXT:    punpcklqdq {{.*#+}} xmm0 = xmm0[0],xmm1[0]
; CHECK-NOCX16-O0-NEXT:    popq %rax
; CHECK-NOCX16-O0-NEXT:    .cfi_def_cfa_offset 8
; CHECK-NOCX16-O0-NEXT:    retq
;
; CHECK-CX16-O0-LABEL: atomic_vec2_double:
; CHECK-CX16-O0:       # %bb.0:
; CHECK-CX16-O0-NEXT:    pushq %rbx
; CHECK-CX16-O0-NEXT:    .cfi_def_cfa_offset 16
; CHECK-CX16-O0-NEXT:    .cfi_offset %rbx, -16
; CHECK-CX16-O0-NEXT:    xorl %eax, %eax
; CHECK-CX16-O0-NEXT:    movl %eax, %ebx
; CHECK-CX16-O0-NEXT:    movq %rbx, %rax
; CHECK-CX16-O0-NEXT:    movq %rbx, %rdx
; CHECK-CX16-O0-NEXT:    movq %rbx, %rcx
; CHECK-CX16-O0-NEXT:    lock cmpxchg16b (%rdi)
; CHECK-CX16-O0-NEXT:    movq %rdx, %xmm1
; CHECK-CX16-O0-NEXT:    movq %rax, %xmm0
; CHECK-CX16-O0-NEXT:    punpcklqdq {{.*#+}} xmm0 = xmm0[0],xmm1[0]
; CHECK-CX16-O0-NEXT:    popq %rbx
; CHECK-CX16-O0-NEXT:    .cfi_def_cfa_offset 8
; CHECK-CX16-O0-NEXT:    retq
;
; CHECK-AVX-O0-LABEL: atomic_vec2_double:
; CHECK-AVX-O0:       # %bb.0:
; CHECK-AVX-O0-NEXT:    vmovapd (%rdi), %xmm0
; CHECK-AVX-O0-NEXT:    retq
  %ret = load atomic <2 x double>, ptr %x acquire, align 16
  ret <2 x double> %ret
}
