...
; SM70-NEXT:    or.b32 %r17, %r20, %r3;
; SM70-NEXT:    or.b32 %r18, %r20, %r4;
; SM70-NEXT:    atom.global.cas.b32 %r7, [%rd1], %r18, %r17;
; SM70-NEXT:    setp.eq.s32 %p1, %r7, %r18;
...
; SM70-NEXT:    or.b32 %r17, %r20, %r3;
; SM70-NEXT:    or.b32 %r18, %r20, %r4;
; SM70-NEXT:    atom.shared.cas.b32 %r7, [%rd1], %r18, %r17;
; SM70-NEXT:    setp.eq.s32 %p1, %r7, %r18;
...
; SM70-NEXT:    or.b32 %r16, %r19, %r3;
; SM70-NEXT:    or.b32 %r17, %r19, %r4;
; SM70-NEXT:    atom.global.cas.b32 %r7, [%rd1], %r17, %r16;
; SM70-NEXT:    setp.eq.s32 %p1, %r7, %r17;
...
; SM70-NEXT:    or.b32 %r16, %r19, %r3;
; SM70-NEXT:    or.b32 %r17, %r19, %r4;
; SM70-NEXT:    atom.shared.cas.b32 %r7, [%rd1], %r17, %r16;
; SM70-NEXT:    setp.eq.s32 %p1, %r7, %r17;
...
; SM70-NEXT:    atom.global.cas.b32 %r3, [%rd1], %r1, %r2;
; SM70-NEXT:    st.param.b32 [func_retval0], %r2;
; SM70-NEXT:    ret;
...
; SM70-NEXT:    atom.shared.cas.b32 %r3, [%rd1], %r1, %r2;
; SM70-NEXT:    st.param.b32 [func_retval0], %r2;
; SM70-NEXT:    ret;
...
; SM70-NEXT:    atom.global.cas.b64 %rd4, [%rd1], %rd2, %rd3;
; SM70-NEXT:    st.param.b64 [func_retval0], %rd3;
; SM70-NEXT:    ret;
...
; SM70-NEXT:    atom.shared.cas.b64 %rd4, [%rd1], %rd2, %rd3;
; SM70-NEXT:    st.param.b64 [func_retval0], %rd3;
; SM70-NEXT:    ret;
