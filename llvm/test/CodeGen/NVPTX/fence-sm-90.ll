...
define void @fence_sc_cluster() local_unnamed_addr {
  ; PTX78: fence.sc.cluster
  ; PTX86: fence.sc.cluster
...
define void @fence_acq_rel_cluster() local_unnamed_addr {
  ; PTX78: fence.acq_rel.cluster
  ; PTX86: fence.acq_rel.cluster
