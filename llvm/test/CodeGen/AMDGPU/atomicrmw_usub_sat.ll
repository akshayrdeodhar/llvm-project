...
; GFX9-GISEL-NEXT:    s_mov_b64 s[4:5], 0
; GFX9-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-GISEL-NEXT:    global_load_dword v1, v0, s[2:3] offset:2048 glc
; GFX9-GISEL-NEXT:    v_mov_b32_e32 v2, 0xffff0000
; GFX9-GISEL-NEXT:  .LBB10_1: ; %atomicrmw.start
; GFX9-GISEL-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX9-GISEL-NEXT:    s_waitcnt vmcnt(0)
; GFX9-GISEL-NEXT:    v_mov_b32_e32 v4, v1
; GFX9-GISEL-NEXT:    v_sub_u16_e64 v1, v4, s6 clamp
; GFX9-GISEL-NEXT:    v_and_or_b32 v3, v4, v2, v1
; GFX9-GISEL-NEXT:    global_atomic_cmpswap v1, v0, v[3:4], s[2:3] offset:2048 glc
; GFX9-GISEL-NEXT:    s_waitcnt vmcnt(0)
; GFX9-GISEL-NEXT:    buffer_wbinvl1_vol
; GFX9-GISEL-NEXT:    v_cmp_eq_u32_e32 vcc, v1, v4
; GFX9-GISEL-NEXT:    s_or_b64 s[4:5], vcc, s[4:5]
; GFX9-GISEL-NEXT:    s_andn2_b64 exec, exec, s[4:5]
...
; GFX9-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-GISEL-NEXT:    global_load_dword v1, v2, s[0:1] offset:2048 glc
...
; GFX10-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-GISEL-NEXT:    global_load_dword v1, v2, s[0:1] glc dlc
...
; GFX11-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-GISEL-NEXT:    global_load_b32 v1, v2, s[0:1] offset:2048 glc
...
; GFX12-GISEL-NEXT:    s_mov_b32 s3, 0
; GFX12-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX12-GISEL-NEXT:    global_load_b32 v1, v2, s[0:1] offset:2048 scope:SCOPE_DEV
...
; GFX9-GISEL-NEXT:    s_mov_b64 s[4:5], 0
; GFX9-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-GISEL-NEXT:    global_load_dword v2, v0, s[2:3] offset:1024 glc
...
; GFX9-GISEL-NEXT:    v_lshlrev_b16_e32 v2, 8, v5
; GFX9-GISEL-NEXT:    v_sub_u16_e64 v2, v2, s6 clamp
; GFX9-GISEL-NEXT:    v_and_b32_sdwa v2, v2, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_1 src1_sel:DWORD
; GFX9-GISEL-NEXT:    v_and_or_b32 v4, v5, v3, v2
; GFX9-GISEL-NEXT:    global_atomic_cmpswap v2, v0, v[4:5], s[2:3] offset:1024 glc
; GFX9-GISEL-NEXT:    s_waitcnt vmcnt(0)
; GFX9-GISEL-NEXT:    buffer_wbinvl1_vol
; GFX9-GISEL-NEXT:    v_cmp_eq_u32_e32 vcc, v2, v5
; GFX9-GISEL-NEXT:    s_or_b64 s[4:5], vcc, s[4:5]
; GFX9-GISEL-NEXT:    s_andn2_b64 exec, exec, s[4:5]
...
; GFX9-GISEL-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX9-GISEL-NEXT:    v_mov_b32_e32 v0, 0
; GFX9-GISEL-NEXT:    global_store_byte v0, v2, s[0:1]
; GFX9-GISEL-NEXT:    s_endpgm
;
...
; GFX10-GISEL-NEXT:    s_mov_b32 s4, 0
; GFX10-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-GISEL-NEXT:    global_load_dword v2, v0, s[0:1] offset:1024 glc dlc
...
; GFX9-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-GISEL-NEXT:    global_load_dword v1, v2, s[0:1] offset:1024 glc
...
; GFX10-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-GISEL-NEXT:    global_load_dword v1, v2, s[0:1] offset:1024 glc dlc
...
; GFX11-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-GISEL-NEXT:    global_load_b32 v1, v2, s[0:1] offset:1024 glc
...
; GFX12-GISEL-NEXT:    s_mov_b32 s3, 0
; GFX12-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX12-GISEL-NEXT:    global_load_b32 v1, v2, s[0:1] offset:1024 scope:SCOPE_DEV
; GFX12-GISEL-NEXT:    s_lshl_b32 s2, s2, 8
