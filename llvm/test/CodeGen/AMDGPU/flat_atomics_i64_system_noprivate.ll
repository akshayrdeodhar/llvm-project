...
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-NEXT:    flat_load_dwordx2 v[6:7], v[0:1] glc
...
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-NEXT:    flat_load_dwordx2 v[6:7], v[0:1] offset:32 glc
; GFX9-NEXT:    s_mov_b64 s[4:5], 0
...
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-NEXT:    flat_load_dwordx2 v[4:5], v[0:1] glc
; GFX9-NEXT:    s_mov_b64 s[4:5], 0
...
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-NEXT:    flat_load_dwordx2 v[4:5], v[0:1] offset:32 glc
; GFX9-NEXT:    s_mov_b64 s[4:5], 0
...
; GFX9-NEXT:    flat_load_dwordx2 v[2:3], v[0:1] glc
...
; GFX9-NEXT:    v_mov_b32_e32 v0, s4
; GFX9-NEXT:    v_mov_b32_e32 v1, s5
; GFX9-NEXT:    flat_load_dwordx2 v[2:3], v[0:1] offset:32 glc
; GFX9-NEXT:    v_mov_b32_e32 v4, s4
; GFX9-NEXT:    s_mov_b64 s[34:35], 0
; GFX9-NEXT:    v_mov_b32_e32 v6, s7
; GFX9-NEXT:    v_mov_b32_e32 v5, s5
...
; GFX7-NEXT:    v_mov_b32_e32 v2, s34
; GFX7-NEXT:    v_mov_b32_e32 v3, s35
; GFX7-NEXT:    flat_load_dwordx2 v[0:1], v[2:3] glc
; GFX7-NEXT:    s_mov_b64 s[34:35], 0
; GFX7-NEXT:    v_mov_b32_e32 v4, s7
...
; GFX8-NEXT:    v_mov_b32_e32 v2, s34
; GFX8-NEXT:    v_mov_b32_e32 v3, s35
; GFX8-NEXT:    flat_load_dwordx2 v[0:1], v[2:3] glc
; GFX8-NEXT:    s_mov_b64 s[34:35], 0
; GFX8-NEXT:    v_mov_b32_e32 v4, s7
...
; GFX9-NEXT:    v_mov_b32_e32 v0, s4
; GFX9-NEXT:    v_mov_b32_e32 v1, s5
; GFX9-NEXT:    flat_load_dwordx2 v[0:1], v[0:1] offset:32 glc
; GFX9-NEXT:    v_mov_b32_e32 v2, s4
; GFX9-NEXT:    s_mov_b64 s[34:35], 0
; GFX9-NEXT:    v_mov_b32_e32 v4, s7
; GFX9-NEXT:    v_mov_b32_e32 v3, s5
...
; GFX9-NEXT:    flat_load_dwordx2 v[2:3], v[4:5] offset:32 glc
...
; GFX9-NEXT:    v_mov_b32_e32 v5, s1
; GFX9-NEXT:    v_mov_b32_e32 v4, s0
; GFX9-NEXT:    flat_load_dwordx2 v[2:3], v[4:5] glc
; GFX9-NEXT:    s_mov_b64 s[0:1], 0
; GFX9-NEXT:    v_mov_b32_e32 v6, s3
; GFX9-NEXT:    v_mov_b32_e32 v7, s2
