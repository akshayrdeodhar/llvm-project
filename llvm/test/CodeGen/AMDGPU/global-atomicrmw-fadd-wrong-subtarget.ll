...
; GCN-NEXT:    v_cvt_f32_ubyte0_e32 v3, s0
; GCN-NEXT:    v_mul_f32_e32 v3, 4.0, v3
...
; GCN-NEXT:    v_add_f32_e32 v4, v5, v3
; GCN-NEXT:    global_atomic_cmpswap v1, v2, v[4:5], s[4:5] glc
; GCN-NEXT:    s_waitcnt vmcnt(0)
