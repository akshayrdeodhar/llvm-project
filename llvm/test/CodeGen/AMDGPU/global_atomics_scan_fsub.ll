...
; GFX1132-NEXT:    v_dual_mov_b32 v2, 0 :: v_dual_mul_f32 v3, 4.0, v0
...
; GFX1132-NEXT:    v_sub_f32_e32 v0, v1, v3
...
; GFX7LESS-DPP:       ; %bb.0:
; GFX7LESS-DPP-NEXT:    s_mov_b64 s[6:7], exec
; GFX7LESS-DPP-NEXT:    v_mbcnt_lo_u32_b32_e64 v0, s6, 0
; GFX7LESS-DPP-NEXT:    v_mbcnt_hi_u32_b32_e32 v0, s7, v0
...
; GFX7LESS-DPP-NEXT:    s_bcnt1_i32_b64 s4, s[6:7]
...
; GFX9-DPP-NEXT:    v_cvt_f32_ubyte0_e32 v0, s2
...
; GFX1064-DPP-NEXT:    v_mul_f32_e32 v3, 4.0, v0
...
; GFX1064-DPP-NEXT:    v_sub_f32_e32 v0, v1, v3
...
; GFX1032-DPP-NEXT:    v_mul_f32_e32 v3, 4.0, v0
...
; GFX1032-DPP-NEXT:    v_sub_f32_e32 v0, v1, v3
...
; GFX1164-DPP-NEXT:    v_mul_f32_e32 v3, 4.0, v0
...
; GFX1164-DPP-NEXT:    v_sub_f32_e32 v0, v1, v3
...
; GFX1132-DPP-NEXT:    v_dual_mov_b32 v2, 0 :: v_dual_mul_f32 v3, 4.0, v0
...
; GFX1132-DPP-NEXT:    v_sub_f32_e32 v0, v1, v3
...
; GFX1064-NEXT:    s_mov_b64 s[2:3], 0
; GFX1064-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1064-NEXT:    global_load_dword v1, v3, s[0:1] glc dlc
...
; GFX1032-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1032-NEXT:    global_load_dword v1, v3, s[0:1] glc dlc
...
; GFX1164-NEXT:    s_mov_b64 s[2:3], 0
; GFX1164-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1164-NEXT:    global_load_b32 v1, v3, s[0:1] glc
...
; GFX1132-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1132-NEXT:    global_load_b32 v1, v3, s[0:1] glc
...
; GFX1064-DPP-NEXT:    s_mov_b64 s[2:3], 0
; GFX1064-DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1064-DPP-NEXT:    global_load_dword v1, v6, s[0:1] glc dlc
...
; GFX1032-DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1032-DPP-NEXT:    global_load_dword v1, v6, s[0:1] glc dlc
...
; GFX1164-DPP-NEXT:    s_mov_b64 s[2:3], 0
; GFX1164-DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1164-DPP-NEXT:    global_load_b32 v5, v6, s[0:1] glc
...
; GFX1132-DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1132-DPP-NEXT:    global_load_b32 v5, v6, s[0:1] glc
...
; GFX7LESS-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
; GFX7LESS-NEXT:    v_add_f64 v[2:3], s[2:3], v[0:1]
; GFX7LESS-NEXT:    s_mov_b32 s3, 0xf000
; GFX7LESS-NEXT:    s_mov_b32 s2, -1
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS-NEXT:    buffer_load_dword v1, off, s[0:3], 0 glc
; GFX7LESS-NEXT:    v_cvt_f32_f64_e32 v0, v[2:3]
; GFX7LESS-NEXT:    v_mul_f32_e32 v2, 4.0, v0
; GFX7LESS-NEXT:    s_mov_b64 s[4:5], 0
...
; GFX9-NEXT:    v_add_f64 v[3:4], s[2:3], v[3:4]
; GFX9-NEXT:    s_mov_b64 s[2:3], 0
; GFX9-NEXT:    v_cvt_f32_f64_e32 v0, v[3:4]
; GFX9-NEXT:    v_mul_f32_e32 v3, 4.0, v0
...
; GFX1064-NEXT:    v_add_f64 v[3:4], 0xc3300000, s[2:3]
; GFX1064-NEXT:    s_mov_b64 s[2:3], 0
; GFX1064-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1064-NEXT:    global_load_dword v1, v2, s[0:1] glc dlc
; GFX1064-NEXT:    v_cvt_f32_f64_e32 v0, v[3:4]
; GFX1064-NEXT:    v_mul_f32_e32 v3, 4.0, v0
...
; GFX1032-NEXT:    v_add_f64 v[3:4], 0xc3300000, s[4:5]
; GFX1032-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1032-NEXT:    global_load_dword v1, v2, s[0:1] glc dlc
; GFX1032-NEXT:    v_cvt_f32_f64_e32 v0, v[3:4]
; GFX1032-NEXT:    v_mul_f32_e32 v3, 4.0, v0
...
; GFX1164-NEXT:    s_waitcnt vmcnt(0)
; GFX1164-NEXT:    v_add_f64 v[2:3], 0xc3300000, v[2:3]
; GFX1164-NEXT:    s_mov_b64 s[2:3], 0
; GFX1164-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1164-NEXT:    global_load_b32 v1, v4, s[0:1] glc
; GFX1164-NEXT:    v_cvt_f32_f64_e32 v0, v[2:3]
...
; GFX1164-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1164-NEXT:    v_sub_f32_e32 v0, v1, v2
; GFX1164-NEXT:    global_atomic_cmpswap_b32 v0, v4, v[0:1], s[0:1] glc
; GFX1164-NEXT:    s_waitcnt vmcnt(0)
; GFX1164-NEXT:    v_cmp_eq_u32_e32 vcc, v0, v1
; GFX1164-NEXT:    v_mov_b32_e32 v1, v0
; GFX1164-NEXT:    s_or_b64 s[2:3], vcc, s[2:3]
...
; GFX1132-NEXT:    s_waitcnt vmcnt(0)
; GFX1132-NEXT:    v_add_f64 v[2:3], 0xc3300000, v[2:3]
; GFX1132-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1132-NEXT:    global_load_b32 v1, v4, s[0:1] glc
; GFX1132-NEXT:    v_cvt_f32_f64_e32 v0, v[2:3]
; GFX1132-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX1132-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1132-NEXT:    v_sub_f32_e32 v0, v1, v2
; GFX1132-NEXT:    global_atomic_cmpswap_b32 v0, v4, v[0:1], s[0:1] glc
; GFX1132-NEXT:    s_waitcnt vmcnt(0)
; GFX1132-NEXT:    v_cmp_eq_u32_e32 vcc_lo, v0, v1
; GFX1132-NEXT:    v_mov_b32_e32 v1, v0
; GFX1132-NEXT:    s_or_b32 s2, vcc_lo, s2
...
; GFX7LESS-DPP-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
; GFX7LESS-DPP-NEXT:    v_add_f64 v[2:3], s[2:3], v[0:1]
; GFX7LESS-DPP-NEXT:    s_mov_b32 s3, 0xf000
; GFX7LESS-DPP-NEXT:    s_mov_b32 s2, -1
; GFX7LESS-DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS-DPP-NEXT:    buffer_load_dword v1, off, s[0:3], 0 glc
; GFX7LESS-DPP-NEXT:    v_cvt_f32_f64_e32 v0, v[2:3]
; GFX7LESS-DPP-NEXT:    v_mul_f32_e32 v2, 4.0, v0
; GFX7LESS-DPP-NEXT:    s_mov_b64 s[4:5], 0
...
; GFX9-DPP-NEXT:    v_add_f64 v[3:4], s[2:3], v[3:4]
; GFX9-DPP-NEXT:    s_mov_b64 s[2:3], 0
; GFX9-DPP-NEXT:    v_cvt_f32_f64_e32 v0, v[3:4]
; GFX9-DPP-NEXT:    v_mul_f32_e32 v3, 4.0, v0
...
; GFX1064-DPP-NEXT:    v_add_f64 v[3:4], 0xc3300000, s[2:3]
; GFX1064-DPP-NEXT:    s_mov_b64 s[2:3], 0
; GFX1064-DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1064-DPP-NEXT:    global_load_dword v1, v2, s[0:1] glc dlc
; GFX1064-DPP-NEXT:    v_cvt_f32_f64_e32 v0, v[3:4]
; GFX1064-DPP-NEXT:    v_mul_f32_e32 v3, 4.0, v0
...
; GFX1032-DPP-NEXT:    v_add_f64 v[3:4], 0xc3300000, s[4:5]
; GFX1032-DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1032-DPP-NEXT:    global_load_dword v1, v2, s[0:1] glc dlc
; GFX1032-DPP-NEXT:    v_cvt_f32_f64_e32 v0, v[3:4]
; GFX1032-DPP-NEXT:    v_mul_f32_e32 v3, 4.0, v0
...
; GFX1164-DPP-NEXT:    s_waitcnt vmcnt(0)
; GFX1164-DPP-NEXT:    v_add_f64 v[2:3], 0xc3300000, v[2:3]
; GFX1164-DPP-NEXT:    s_mov_b64 s[2:3], 0
; GFX1164-DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1164-DPP-NEXT:    global_load_b32 v1, v4, s[0:1] glc
; GFX1164-DPP-NEXT:    v_cvt_f32_f64_e32 v0, v[2:3]
...
; GFX1164-DPP-NEXT:    global_atomic_cmpswap_b32 v0, v4, v[0:1], s[0:1] glc
; GFX1164-DPP-NEXT:    s_waitcnt vmcnt(0)
; GFX1164-DPP-NEXT:    v_cmp_eq_u32_e32 vcc, v0, v1
; GFX1164-DPP-NEXT:    v_mov_b32_e32 v1, v0
; GFX1164-DPP-NEXT:    s_or_b64 s[2:3], vcc, s[2:3]
...
; GFX1132-DPP-NEXT:    s_waitcnt vmcnt(0)
; GFX1132-DPP-NEXT:    v_add_f64 v[2:3], 0xc3300000, v[2:3]
; GFX1132-DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1132-DPP-NEXT:    global_load_b32 v1, v4, s[0:1] glc
; GFX1132-DPP-NEXT:    v_cvt_f32_f64_e32 v0, v[2:3]
; GFX1132-DPP-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX1132-DPP-NEXT:    global_atomic_cmpswap_b32 v0, v4, v[0:1], s[0:1] glc
; GFX1132-DPP-NEXT:    s_waitcnt vmcnt(0)
; GFX1132-DPP-NEXT:    v_cmp_eq_u32_e32 vcc_lo, v0, v1
; GFX1132-DPP-NEXT:    v_mov_b32_e32 v1, v0
; GFX1132-DPP-NEXT:    s_or_b32 s2, vcc_lo, s2
...
; GFX7LESS-NEXT:    v_cvt_f64_u32_e32 v[0:1], s4
...
; GFX1064-NEXT:    s_mov_b64 s[2:3], 0
; GFX1064-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1064-NEXT:    global_load_dwordx2 v[2:3], v6, s[0:1] glc dlc
...
; GFX1032-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1032-NEXT:    global_load_dwordx2 v[2:3], v6, s[0:1] glc dlc
...
; GFX7LESS-DPP-NEXT:    v_cvt_f64_u32_e32 v[0:1], s4
...
; GFX1064-DPP-NEXT:    s_mov_b64 s[2:3], 0
; GFX1064-DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1064-DPP-NEXT:    global_load_dwordx2 v[2:3], v6, s[0:1] glc dlc
...
; GFX1032-DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1032-DPP-NEXT:    global_load_dwordx2 v[2:3], v6, s[0:1] glc dlc
...
; GFX9-DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-DPP-NEXT:    global_load_dwordx2 v[11:12], v0, s[2:3] glc
...
; GFX1064-DPP-NEXT:    s_mov_b64 s[2:3], 0
; GFX1064-DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1064-DPP-NEXT:    global_load_dwordx2 v[9:10], v2, s[0:1] glc dlc
...
; GFX1032-DPP-NEXT:    s_load_dwordx2 s[0:1], s[34:35], 0x24
; GFX1032-DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1032-DPP-NEXT:    global_load_dwordx2 v[9:10], v2, s[0:1] glc dlc
...
; GFX1164-DPP-NEXT:    s_mov_b64 s[2:3], 0
; GFX1164-DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1164-DPP-NEXT:    global_load_b64 v[8:9], v10, s[0:1] glc
