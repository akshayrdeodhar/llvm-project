...
; GFX11-TRUE16-NEXT:    global_load_b32 v3, v0, s[4:5] offset:4
; GFX11-TRUE16-NEXT:    global_load_b32 v1, v2, s[0:1] glc
...
; GFX11-TRUE16-NEXT:    global_atomic_cmpswap_b32 v0, v2, v[0:1], s[0:1] glc
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0)
...
; GFX11-FAKE16-NEXT:    v_dual_mov_b32 v2, 0 :: v_dual_lshlrev_b32 v3, 16, v0
; GFX11-FAKE16-NEXT:    global_load_b32 v1, v2, s[0:1] glc
...
; GFX11-FAKE16-NEXT:    global_atomic_cmpswap_b32 v0, v2, v[0:1], s[0:1] glc
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(0)
